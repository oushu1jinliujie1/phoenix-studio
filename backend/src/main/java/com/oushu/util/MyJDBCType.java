...
public enum MyJDBCType implements SQLType {
     ...
     * @see Types
     */
    public static MyJDBCType valueOf(int type) {
        for( MyJDBCType sqlType : MyJDBCType.class.getEnumConstants()) {
